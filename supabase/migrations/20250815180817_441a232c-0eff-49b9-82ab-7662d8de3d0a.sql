...
INSERT INTO public.servicos (user_id, nome, descricao, valor) VALUES
(auth.uid(), 'Consultoria', 'Serviço de consultoria especializada', 500.00),
(auth.uid(), 'Desenvolvimento', 'Desenvolvimento de software personalizado', 1200.00),
(auth.uid(), 'Suporte Técnico', 'Suporte técnico mensal', 300.00),
(auth.uid(), 'Treinamento', 'Treinamento para equipe', 800.00);