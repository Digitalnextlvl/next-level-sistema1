...
export function MetaProgress() {
  ...
  return <TooltipProvider>
      <div className="flex items-center gap-1 px-2 py-1 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/95 border rounded-md text-xs sm:text-sm">
        <Tooltip>
          <TooltipTrigger asChild>
            <div className="flex items-center gap-1 cursor-pointer">
              <span className="font-medium hidden sm:inline">Meta:</span>
              <Target className="h-3 w-3 sm:hidden text-primary" />
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <Progress value={progresso.percentual_faturamento} className="w-20 sm:w-24 h-2" />
        ...
        {progresso.percentual_faturamento >= 100 && (
          <Badge variant="default" className="bg-green-500 text-white text-xs ml-1 hidden sm:flex">
